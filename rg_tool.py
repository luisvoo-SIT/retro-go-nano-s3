...
PROJECT_APPS = {
  ...
  'launcher':     [0, 16, 1835008],  # 1.75 MB
  'retro-core':   [0, 16, 1572864],  # 1.5 MB
  'gnuboy':       [0, 16, 1572864],  # 1.5 MB (Original size kept)
  'snes':         [0, 16, 1048576],  # 1.0 MB
  'prboom-go':    [0, 16, 1310720],  # 1.25 MB
...
PROJECT_VER = "nochii-1.03(Reiss edit)"
FW_FORMAT = "none"
